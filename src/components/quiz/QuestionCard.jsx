    ...
    <div className="glass-card rounded-3xl p-6 sm:p-8 border border-white/10 relative overflow-hidden shadow-2xl">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 pb-5 border-b border-white/10">
        ...
        <div className="flex items-center gap-3">
          {secondsLeft !== null && (
            <div className={`px-3 py-1 rounded-lg font-mono text-xs font-bold border flex items-center gap-1.5 ${secondsLeft <= 10
      ...
      {question.codeSnippet && question.questionType !== 'CODE_COMPLETION' && (
      ...
      <div className="my-2">
        ...
        {question.questionType === 'ARRANGE_SEQUENCE' && (
          <SequenceRenderer
        ...
        {(question.questionType === 'DESCRIPTIVE' || question.questionType === 'CASE_STUDY') && (
          <DescriptiveRenderer
            value={answer || ''}
            onChange={onAnswerChange}
            disabled={!!evaluation}
